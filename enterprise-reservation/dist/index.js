...
class EnterpriseReservationsServer {
            ...
            try {
                switch (name) {
                    case "get_reservation_details":
                        return await this.getReservationDetails(args);
                    case "list_reservations":
                        return await this.listReservations(args);
                    case "create_reservation":
                        return await this.createReservation(args);
                    case "modify_reservation":
                        return await this.modifyReservation(args);
    ...
    async getReservationDetails(args) {
        try {
    ...
    async modifyReservation(args) {
        try {
            ...
            if (args.pickupLocation)
                updateData.pickupLocation = args.pickupLocation;
            if (args.returnLocation)
                updateData.returnLocation = args.returnLocation;
            if (args.pickupDate)
                updateData.pickupDate = args.pickupDate;
            if (args.returnDate)
                updateData.returnDate = args.returnDate;
            if (args.pickupTime)
                updateData.pickupTime = args.pickupTime;
            if (args.returnTime)
                updateData.returnTime = args.returnTime;
            if (args.vehicleClass)
                updateData.vehicleClass = args.vehicleClass;
